...
I<HTTP HEADERS> can be used to send a list of HTTP headers
...
of the host as specified in the statement. Specifying a host header
is useful if you want to connect and test a name-based virtual host.
The syntax is
