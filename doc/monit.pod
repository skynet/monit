...
I<SSLAUTO> defaults will select the method automatically, but note
that only TLS methods are supported. If you need SSLv2 or SSLv3 you
have to explicitly select that method using I<SSLV2> or I<SSLV3>
option.
