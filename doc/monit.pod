...
Parameters are whitespace separated strings and in the above example
the strings '-lrt' and '/tmp/' are parameters to the program '/bin/ls'.
...
Parameters can be sent with the program, for example:
